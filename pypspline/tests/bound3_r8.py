...
import Numeric as N
from pspline3_r8 import pspline3_r8, griddata
EPS = 1.e-10
...
def periodic1():
    ...
    spl = pspline3_r8(x1, x2, x3, bcs1=1, bcs2=None, bcs3=None)
    spl.setup(ff)
...
def periodic2():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=None, bcs2=1, bcs3=None)
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
    x2 = linspace(0., 2*N.pi, n2-1)
    x3 = linspace(0., 2*N.pi, n3-1)
...
def periodic3():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=None, bcs2=None, bcs3=1)
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
    x2 = linspace(0., 2*N.pi, n2-1)
    x3 = linspace(0., 2*N.pi, n3-1)
...
def allPeriodic():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=1, bcs2=1, bcs3=1)
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
    x2 = linspace(0., 2*N.pi, n2-1)
    x3 = linspace(0., 2*N.pi, n3-1)
...
def slope1():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=(1,1), bcs2=None, bcs3=None)
    spl.bcval1min = N.zeros( (n3, n2), N.Float64 )
    spl.bcval1max = N.zeros( (n3, n2), N.Float64 )
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
    x2 = linspace(0., 2*N.pi, n2-1)
    x3 = linspace(0., 2*N.pi, n3-1)
...
def slope2():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=None, bcs2=(1,1), bcs3=None)
...
def slope3():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=None, bcs2=None, bcs3=(1,1))
    spl.bcval3min = N.zeros( (n2, n1), N.Float64 )
    spl.bcval3max = N.zeros( (n2, n1), N.Float64 )
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
    x2 = linspace(0., 2*N.pi, n2-1)
    x3 = linspace(0., 2*N.pi, n3-1)
...
def secondDer1():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=(2,2), bcs2=1, bcs3=1)
    spl.bcval1min = N.zeros( (n3, n2), N.Float64 )
    spl.bcval1max = N.zeros( (n3, n2), N.Float64 )
    spl.setup(ff)
    x1 = linspace(0., 2*N.pi, n1-1)
...
def secondDer2():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=1, bcs2=(2,2), bcs3=1)
...
def secondDer3():
    ...
    xx1, xx2, xx3 = griddata(x1, x2, x3)
    ff = N.cos(xx1)*N.sin(xx2)*N.cos(2*xx3)
    spl = pspline3_r8(x1, x2, x3, bcs1=1, bcs2=1, bcs3=(2,2))
